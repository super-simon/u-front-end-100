...
const addBlueBackgroundButton = document.getElementById(
  "add-blue-background-button"
);
...
// }
// document
//   .getElementById("add-blue-background-button")
...
// addBlueBackgroundButton.addEventListener("click", changeBackgroundColor);
...
function changeBackgroundColor() {
  thirdParagraphElement.style.backgroundColor = "blue";
  thirdParagraphElement.classList.add("blue");
}
